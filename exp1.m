...
Discretization=zeros(size(Num_Log));
...
Discretization(ii)=(1-TotalDataNumber*Threshold)*100;
...
figure;plot(Num_Log,GeneratedAccuracy,'b');title('GeneratedAccuracy and Discretization Error');
    hold on;plot(Num_Log,Discretization,'r');
